...
export const previewRoutes: PublicPage[] = [
  {
    ...
    h1: 'Partner Preview',
    intro: 'A public-safe preview for partners exploring SANCTUM Studio as a premium room design and sanctuary system.',
  ...
  },
  {
    ...
    tune: ['Review the public guides', 'Map the room archetypes', 'Keep the preview strategic and public-safe'],
